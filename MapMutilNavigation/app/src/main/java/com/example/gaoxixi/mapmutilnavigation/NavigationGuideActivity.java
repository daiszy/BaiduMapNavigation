...
public class NavigationGuideActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // setContentView(R.layout.activity_navigation_guide);
        ...
        View view = mNaviHelper.onCreate(NavigationGuideActivity.this);
        if (view != null) {
            setContentView(view);
        }

        mNaviHelper.startBikeNavi(NavigationGuideActivity.this);

        /**发起骑行路径规划**/
//        routePlanSearch = RoutePlanSearch.newInstance();
//        routePlanSearch.bikingSearch(bikingRoutePlanOption.from().to());
